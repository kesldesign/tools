...
//BoundarX space of main shape
boundY = space * gridCountY;
boundX = space * gridCountX;

spliting = trayCount-2;
traySize = boundX/trayCount;
trayPerc = (trayCutHeight/(trayDepth/200))/100;
...
difference()
{
    ...
    antislip_size = 10.5;
    antislip_offset = 5;
    translate([(boundX/2)-(antislip_size/2)-antislip_offset,(boundY/2)-(antislip_size/2)-antislip_offset,-3.2]) cyl(h=2, d=antislip_size, center=true);
    translate([(boundX/-2)-(antislip_size/-2)+antislip_offset,(boundY/2)-(antislip_size/2)-antislip_offset,-3.2]) cyl(h=2, d=antislip_size, center=true);
    translate([(boundX/-2)-(antislip_size/-2)+antislip_offset,(boundY/-2)-(antislip_size/-2)-trayDepth+antislip_offset,-3.2]) cyl(h=2, d=antislip_size, center=true);
    translate([(boundX/2)-(antislip_size/2)-antislip_offset,(boundY/-2)-(antislip_size/-2)-trayDepth+antislip_offset,-3.2]) cyl(h=2, d=antislip_size, center=true);
    }
}
